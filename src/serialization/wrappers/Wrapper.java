...
public abstract class Wrapper {
    ...
    public Wrapper(Class<?> clazz, Formatter formatter) {
        ...
        String message = canBeWrapped();
        if (message != null)
            throw new IllegalArgumentException(message);
    }

    public Object readValue(String yaml) {
        return readValueInner(formatter.removeComments(yaml));
    }

    protected abstract Object readValueInner(String yaml);

    public abstract String writeValue(Object value);

    protected abstract String canBeWrapped();
