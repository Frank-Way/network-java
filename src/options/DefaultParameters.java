...
public abstract class DefaultParameters {
    public static final int RETRIES = 3;  // количество перезапусков одной конфигурации
    ...
    public static final int EPOCHS = 1000;  // количество эпох обучения
    public static final boolean PRE_TRAIN_REQUIRED = true;  // флаг необходимости предобучения
    public static final int PRE_TRAINS_COUNT = 5;  // количество попыток предобучения
