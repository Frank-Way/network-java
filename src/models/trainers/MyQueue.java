 ...
 * <pre><ul>
 *  <li>actualSize - количество вставленных элементов;</li>
 *  <li>size       - размер структуры;</li>
 *  <li>values     - массив элементов;</li>
 *  <li>lastPushed - индекс, по которому был записан последний элемент.</li>
 * </ul></pre>
 */
